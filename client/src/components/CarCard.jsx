    ...
    // Be flexible about the availability field name/format
    const available = car?.isAvaliable === true;
    ...
    return (
        ...
        {available && (
    <p className="absolute top-4 left-4 z-10 bg-green-600 text-white text-xs px-2.5 py-1 rounded-full">
        Available Now
    </p>
    )}
